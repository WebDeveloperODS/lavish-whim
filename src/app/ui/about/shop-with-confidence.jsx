...
export default function ShopWithConfidence(){
      ...
      <div className="flex gap-10 w-full my-8">
            <Image className="w-[40vw] h-[30vh] rounded-xl shadow-md object-cover object-center object-fixed" alt="Our Vision - About Lavish Whim" width={800} height={800} src={'/images/about-us/6.jpg'}/>
