...
export default function CraftsmanshipWithConfidence(){
      return ( 
      <div className="flex flex-col-reverse lg:flex-row gap-6 lg:gap-10 w-full my-10 lg:my-8">
            ...
            <Image className="w-full lg:w-[40vw] h-[30vh] rounded-xl shadow-md object-cover object-center object-fixed" alt="Our Vision - About Lavish Whim" width={800} height={800} src={'/images/about-us/4.jpg'}/>
      </div> 
      )
}