...
export default function OurVision(){
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 w-full my-10 lg:my-8">
            <Image className="w-full lg:w-[40vw] h-[30vh] rounded-xl shadow-md object-cover object-center" alt="Our Vision - About Lavish Whim" width={800} height={800} src={'/images/about-us/3.jpg'}/>
            <div className="w-full h-auto flex flex-col justify-center gap-3 lg:gap-6 lg:py-5">
                  ...
                  <Link className="text-sm lg:text-md border-2 border-black w-fit px-4 py-2 rounded-sm font-bold tracking-wide transition-all ease-in-out duration-400 hover:scale-[1.02] hover:text-white hover:bg-black" href={'/bags-by-lavish-whim'}>Explore Our Products</Link>
            </div>
      </div> 
      )
}