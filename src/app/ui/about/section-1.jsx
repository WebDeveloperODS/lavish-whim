...
export default function AboutIntro(){
      return(
            <div className="flex flex-col w-full py-8">
                  <img className="object-center w-full h-[65vh] rounded-xl shadow-md" src={'/images/about-us/1.jpg'} alt="About Lavish Whim - 1"/>
                  <div className="flex flex-col gap-3 justify-center items-center mt-8 lg:mt-12">
                        <SectionHead1 className={'font-bold uppercase tracking-wider underline underline-offset-4 decoration-3 decoration-red-700'}>The Home of Quality Pakistani Fashion</SectionHead1>
